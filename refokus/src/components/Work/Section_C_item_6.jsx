...
export default function Section_C_item_6({style, Hovered6, handleHover6, handleLeave6}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    className={`${style.wrapper} ${Hovered6 ? style.hovered : ''} ${Hovered6 ? style.bg6 : ''}`}>
                        ...
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>We enhanced the New York Fashion Week, by creating a fully digital AR fashion experience for Yahoo and Maisie Wilen, featuring holographic 3D models and an integrated web shop.</p>
                            </div>
