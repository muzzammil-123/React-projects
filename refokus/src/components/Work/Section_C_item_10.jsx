...
export default function Section_C_item_10({style, Hovered10, handleHover10, handleLeave10}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    onMouseLeave={()=>{handleLeave10()}} 
                    className={`${style.wrapper} ${Hovered10 ? style.hovered : ''} ${Hovered10 ? style.bg10 : ''}`}>
                        <div className={style.text_wrapper}>
                            <h3>Remind</h3>
                        </div>
                        <div className={`${style.onHover}`}>
                            <video preload='none' playsInline muted autoPlay loop width={"100%"} style={{ borderRadius: '16px' }}>
                                <source src="https://cdn.refokus.com/website/2022/videos/remind.webm" />
                            </video>
                        </div>
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>Remind got a new website that is designed and developed to be easy to maintain and ready to learn, reflecting their mission to connect students and families.</p>
                            </div>
