...
export default function Section_C_item_2({style, Hovered2, handleHover2, handleLeave2}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    className={`${style.wrapper} ${Hovered2 ? style.hovered : ''} ${Hovered2 ? style.bg2 : ''}`}>
                        ...
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>We immersed ourselves in a 3D world we created to explain how Cula's platform collects data from carbon removal processes and converts them into carbon credit certificates.</p>
                            </div>
