...
export default function Section_C_item_7({style, Hovered7, handleHover7, handleLeave7}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    className={`${style.wrapper} ${Hovered7 ? style.hovered : ''} ${Hovered7 ? style.bg7 : ''}`}>
                        ...
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>We crafted a website for Rainfall Ventures, developing prototypes and custom code that ultimately allows their team to update content regularly and with ease.</p>
                            </div>
