...
export default function Section_C_item_4({style, Hovered4, handleHover4, handleLeave4}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    className={`${style.wrapper} ${Hovered4 ? style.hovered : ''} ${Hovered4 ? style.bg4 : ''}`}>
                        ...
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>A global early-stage venture fund partnering with founders to advance cleaner, safer, and more sustainable movement of people and goods.</p>
                            </div>
