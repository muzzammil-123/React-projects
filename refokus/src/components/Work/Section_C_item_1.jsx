...
export default function Section_C_item_1({style, Hovered, handleHover, handleLeave}) {
  return (
    <>
    <div className={style.container}>
                <div className={style.relative}>
                    ...
                    className={`${style.wrapper} ${Hovered ? style.hovered : ''} ${Hovered ? style.bg : ''}`}>
                        ...
                        <div className={style.flex_right}>
                            <div className={style.para}>
                                <p>With a continuous 3D animation, we showcase Arqitel approach and show how migration data translates into real estate.</p>
                            </div>
