...
export default function Section_C_item_13({style, Hovered13, handleHover13, handleLeave13}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    onMouseLeave={()=>{handleLeave13()}} 
                    className={`${style.wrapper} ${Hovered13 ? style.hovered : ''} ${Hovered13 ? style.bg13 : ''}`}>
                        <div className={style.text_wrapper}>
                            <h3>RocketChat</h3>
                        </div>
                        <div className={`${style.onHover}`}>
                            <video preload='none' playsInline muted autoPlay loop width={"100%"} style={{ borderRadius: '16px' }}>
                                <source src="https://cdn.refokus.com/website/2022/videos/rocketchat.webm" />
                            </video>
                        </div>
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>We built a beautiful, clean website in Webflow for RocketChat that is scalable, easy to maintain and built in a modular manner for future changes.</p>
                            </div>
