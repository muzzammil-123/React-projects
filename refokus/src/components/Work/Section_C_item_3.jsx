...
export default function Section_C_item_3({style, Hovered3, handleHover3, handleLeave3}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    className={`${style.wrapper} ${Hovered3 ? style.hovered : ''} ${Hovered3 ? style.bg3 : ''}`}>
                        ...
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>We've created an interactive site using generative AI to allow users to engage with our thinking about Ai, industry trends and design.</p>
                            </div>
