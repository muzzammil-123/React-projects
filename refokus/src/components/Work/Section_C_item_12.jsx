...
export default function Section_C_item_12({style, Hovered12, handleHover12, handleLeave12}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    onMouseLeave={()=>{handleLeave12()}} 
                    className={`${style.wrapper} ${Hovered12 ? style.hovered : ''} ${Hovered12 ? style.bg12 : ''}`}>
                        <div className={style.text_wrapper}>
                            <h3>Like Magic</h3>
                        </div>
                        <div className={`${style.onHover}`}>
                            <video preload='none' playsInline muted autoPlay loop width={"100%"} style={{ borderRadius: '16px' }}>
                                <source src="https://cdn.refokus.com/website/2022/videos/weglotlikemagic.webm" />
                            </video>
                        </div>
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>We designed and developed a magical gaming experience made in Webflow to promote the translation service and their sponsorship of the 2022 Webflow Conference.</p>
                            </div>
