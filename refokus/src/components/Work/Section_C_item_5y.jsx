...
export default function Section_C_item_5({style, Hovered5, handleHover5, handleLeave5}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    className={`${style.wrapper} ${Hovered5 ? style.hovered : ''} ${Hovered5 ? style.bg5 : ''}`}>
                        <div className={style.text_wrapper}>
                            <h3>YIR 2022</h3>
                        </div>
                        <div className={`${style.onHover}`}>
                            <video preload='none' playsInline muted autoPlay loop width={"100%"} style={{ borderRadius: '16px' }}>
                                <source src="https://cdn.dribbble.com/userupload/8746935/file/original-0de35b1a98d391f9e4e7d5785086fcb0.mp4" />
                            </video>
                        </div>
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>Our second year was filled with great events, exciting projects, awards and amazing people - so we made another showcase to celebrate.</p>
                            </div>
