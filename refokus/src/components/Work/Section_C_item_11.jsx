...
export default function Section_C_item_11({style, Hovered11, handleHover11, handleLeave11}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    onMouseLeave={()=>{handleLeave11()}} 
                    className={`${style.wrapper} ${Hovered11 ? style.hovered : ''} ${Hovered11 ? style.bg11 : ''}`}>
                        ...
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>We created a website for Summon that showcases their innovative technology through animated and captivating UI components and emerging technologies.</p>
                            </div>
