...
export default function Section_C_item_9({style, Hovered9, handleHover9, handleLeave9}) {
  return (
    <>
    <div className={style.container} style={{paddingTop: '0px'}}>
                <div className={style.relative}>
                    ...
                    onMouseLeave={()=>{handleLeave9()}} 
                    className={`${style.wrapper} ${Hovered9 ? style.hovered : ''} ${Hovered9 ? style.bg9 : ''}`}>
                        <div className={style.text_wrapper}>
                            <h3>Jungle</h3>
                        </div>
                        <div className={`${style.onHover}`}>
                            <video preload='none' playsInline muted autoPlay loop width={"100%"} style={{ borderRadius: '16px' }}>
                                <source src="https://cdn.refokus.com/website/jungle-4-3-.webm" />
                            </video>
                        </div>
                        <div className={style.flex_right}>
                            <div className={style.para} style={{marginBottom: '10px'}}>
                                <p>We crafted a timeless visual system for Jungle Ventures, covering all aspects of web design, and empowered their marketing team to scale organically using Webflow.</p>
                            </div>
